                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-3">
                        <span dangerouslySetInnerHTML={{ 
                          __html: highlightText(resolution.title, searchTerm) 
                        }} />
                      </h3>
                      ...
                      <span dangerouslySetInnerHTML={{ 
                        __html: highlightText(resolution.description, searchTerm) 
                      }} />
                    ) : (
                      resolution.title
                    )}
                  ...
                  <div className="text-gray-600 leading-relaxed">
                    {resolution.highlighted_description ? (
                      <span 
                        dangerouslySetInnerHTML={{ __html: resolution.highlighted_description }}
                        // Safe to use dangerouslySetInnerHTML here as content is generated by PostgreSQL's ts_headline function
                      />
                    ) : (
